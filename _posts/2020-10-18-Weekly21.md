...
$$
P(\text{mystery message} \mid Rohan) = \displaystyle{\prod} \frac{\text{# of times word occurs in Rohan's count vector}}{\text{Total number of words in Rohan's dictionary}}
$$
