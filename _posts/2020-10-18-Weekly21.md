...
$$
P(\text{mystery message} \mid Rohan) = \prod_{word in message} \frac{\text{# of times word occurs in Rohan's count vector}}{\text{Total number of words in Rohan's dictionary}}
$$
...
$$
P(\text{mystery message}) = \prod_{word in message} \frac{\text{# of times word occurs in all messages}}{\text{Total number of words (with repeats) in full dictionary}}
$$
